...
//Se Existir essa Variavel [submit] = faca
    if(isset($_POST['submit']))
    {
        ...
        //print_r('<br>');
        //print_r('tel-cel'.$_POST['data_nasc']);
        //print_r('<br>');
        ...
        $resultado = mysqli_query($conexao, "INSERT INTO formulario(nome_cliete, cidade_municipio, sistema_usado, telefone,
        sexo, date_nascimento)VALUES ($nome, $cidade, $sistema_usado, $tel_cel, $genero, $data_nasc)");
    ...
    <div class="box">
        <form action="index.php" method="POST">
            <fieldset>
                ...
                <hr>
                <br>
                <label for="data_nasc"><b>Data do Atendimento</b></label>
                <input type="date" name="data_nasc" id="data_nasc" required>
                <br><br>
                <input type="submit" name="submit" id="submit">
                <br><br>
                <button id="submit" href="">Consultar Clientes</button>
            </fieldset>
